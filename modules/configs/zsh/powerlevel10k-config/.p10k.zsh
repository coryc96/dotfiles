# Generated by Powerlevel10k configuration wizard on 2023-02-24 at 15:23 EST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh.
# Wizard options: awesome-fontconfig, large icons, classic, unicode, dark, flat heads,
# flat tails, 2 lines, disconnected, full frame, sparse, few icons, fluent,
